...
import { StampComponent } from 'app/entities/stamp/stamp.component';
import { StampService } from 'app/entities/stamp/stamp.service';
import { Stamp } from 'app/shared/model/stamp.model';

describe('Component Tests', () => {
    describe('Stamp Management Component', () => {
        let comp: StampComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(StampComponent, '')
                .compileComponents();
